...
from lynda import (DEV_USERS, LOGGER, OWNER_ID, SUDO_USERS, SARDEGNA_USERS, SUPPORT_USERS,
                    WHITELIST_USERS, spam_watch, dispatcher, MESSAGE_DUMP)
...
from lynda.modules.sql.global_bans_sql import is_user_gbanned
...
def new_member(update: Update, context: CallbackContext):
    ...
    for new_mem in new_members:
        ...
        if spam_watch != None:
            sw_ban = spam_watch.get_ban(new_mem.id)
            if sw_ban:
                return
        ...
        if should_welc:
            ...
            # Welcome Support
                ...
                update.effective_message.reply_text(
                    "Huh! Someone with a Sakura Nation just joined!",
                    reply_to_message_id=reply,
                )
                continue
            ...
            # Welcome yourself
                ...
                update.effective_message.reply_text("Hi, Thank you for Adding me to your group ^_^ and make sure to make me an admin to get things started")
                creator = None
