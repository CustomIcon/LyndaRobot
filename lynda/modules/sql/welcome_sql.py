...
DEFAULT_WELCOME_MESSAGES = [
    ...
    "Welcome {first}, Avoid Guns if you can!",
    ...
    "I'm looking for Alienoids, oh wait nvm it's {first}.",
    "Welcome {first}, leaving is not an option!",
    "Run Forest! ..I mean...{first}.",
    "{first} Commander, have you eaten already? I have some dim sum here.",
    "Huh?\nDid someone with a Nations level just join?\nOh wait, it's just {first}.",
    "Hey, {first}, ever heard the Eagle Union?",
